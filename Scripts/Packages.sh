...
UPDATE_PACKAGE "luci-app-onliner" "Ladavian/openwrt_pkgs" "main" "pkg"
UPDATE_PACKAGE "luci-app-timecontrol" "Ladavian/openwrt_pkgs" "main" "pkg"
UPDATE_PACKAGE "luci-app-lucky-pkgs" "Ladavian/openwrt_pkgs" "main" "pkg"
